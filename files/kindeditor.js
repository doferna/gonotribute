...
function _getInitHtml(themesPath, bodyClass, cssPath, cssData) {
	var arr = [
		...
		'<style>',
		'body {font-family:arial,sans-serif;font-size:83%;0 27px 6px 21px;margin:0;direction:left;overflow:hidden;}',
    'td, input, textarea {font-family:arial,sans-serif;} ',
    'table, textarea {font-size:100%;} ',
    'img {border: 0}',
    '.nb_bq {margin:0 0 0.25ex 0;border-left:1px #ccc solid;padding-left:1ex;} ',
    '.nb_c {background: #E7EEF2;padding: 6px 27px 6px 26px;margin: 6px -27px -6px -21px;border-top:1px solid #BCD1F3; } ',
...
_extend(KEdit, KWidget, {
	init : function(options) {
		...
		// cambiado
		html = '<iframe id="iframe-editor" tabindex="-1" class="ac editable" frameborder="0" style="display: none; z-index: 5; border: 0px solid red; padding: 0pt; background-color: rgb(255, 255, 255); width: 1034px; height: 64px; top: 16px; left: 30px;"> </iframe>';
		self.iframe = K(html);
		...
		//self.div.append(self.iframe); // here!
		// hack
		$(self.iframe).appendTo($('#main_container'));
		$(self.iframe).hide();
